...
%TODO: This dissertation covers three electrochemical reactions. The
% first reaction, the electron transfer reaction will be used as a
% tool for expodition. As we build up our methodologies we will be
% testing them on this reaction. To demonstrate that the methods work
% but to also gain som eintuition for the methods before moving into
% higher-dimensional, more complex problems.

% In general, we will choose experimental setups that allow to to
% solve the inverse problem. And we may look at how well the
% inference copes when there is uncertainty.
