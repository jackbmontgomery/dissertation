...
alpha2_params = HeterogenousECirreMechanismFDMParams(
    ...
    alpha2=alpha2_range,
    K2_0=jnp.full_like(alpha2_range, base_params.K2_0),
    E2_f=jnp.full_like(alpha2_range, base_params.E2_f),
...
K2_0_params = HeterogenousECirreMechanismFDMParams(
    ...
    alpha2=jnp.full_like(K2_0_range, base_params.alpha2),
    K2_0=K2_0_range,
    E2_f=jnp.full_like(K2_0_range, base_params.E2_f),
...
dC_params = HeterogenousECirreMechanismFDMParams(
    ...
    alpha2=jnp.full_like(dC_range, base_params.alpha2),
    K2_0=jnp.full_like(dC_range, base_params.K2_0),
    E2_f=jnp.full_like(dC_range, base_params.E2_f),
...
dD_params = HeterogenousECirreMechanismFDMParams(
    ...
    alpha2=jnp.full_like(dD_range, base_params.alpha2),
    K2_0=jnp.full_like(dD_range, base_params.K2_0),
    E2_f=jnp.full_like(dD_range, base_params.E2_f),
...
K_het_params = HeterogenousECirreMechanismFDMParams(
    ...
    E1_f=jnp.full_like(K2_0_range, base_params.E1_f),
    alpha2=jnp.full_like(K2_0_range, base_params.alpha2),
    K2_0=jnp.full_like(K2_0_range, base_params.K2_0),
    E2_f=jnp.full_like(K2_0_range, base_params.E2_f),
    dB=jnp.full_like(K2_0_range, base_params.dB),
    dC=jnp.full_like(K2_0_range, base_params.dC),
    dD=jnp.full_like(K2_0_range, base_params.dD),
