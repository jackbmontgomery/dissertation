...
The corresponding forward problem is predicting the current response
...
distinct parameter configurations can produce similar current responses,
...
with an automatic differentiation framework, \emph{JAX}
