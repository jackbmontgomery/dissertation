...
Throughout this process the current $I$ is recorded. The triangle
waveform and the resulting voltammagram are shown in the left and
right panels of \cref{fig:potential-voltammagram}, respectively.
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.8\textwidth]{figures/2-voltammagram.png}
  \end{center}
